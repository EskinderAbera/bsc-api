# Generated by Django 4.0.5 on 2022-07-29 07:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Perspective',
            fields=[
                ('perspective_id', models.IntegerField(auto_created=True, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='Objectives',
            fields=[
                ('objective_id', models.IntegerField(auto_created=True, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='KPI',
            fields=[
                ('kpi_id', models.IntegerField(auto_created=True, primary_key=True, serialize=False, unique=True)),
