...
class Perspective(models.Model):
    perspective_id = models.IntegerField(primary_key=True, unique=True, auto_created=True)
...
class Objectives(models.Model):
    objective_id = models.IntegerField(primary_key=True, unique=True, auto_created=True)
...
class KPI(models.Model):
    kpi_id = models.IntegerField(primary_key=True, unique=True, auto_created=True)
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='director_user')
