# Generated by Django 4.0.5 on 2022-07-04 12:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perspective', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='IS.perspective')),
            ],
        ),
        migrations.CreateModel(
            name='KPI',
            fields=[
                ...
                ('objective', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='IS.objectives')),
                ('perspective', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='IS.perspective')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='is_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
