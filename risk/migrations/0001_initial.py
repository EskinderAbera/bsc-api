    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perspective', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='risk.perspective')),
            ],
        ),
        migrations.CreateModel(
            name='KPI',
            fields=[
                ...
                ('objective', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='risk.objectives')),
                ('perspective', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='risk.perspective')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='risk_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
