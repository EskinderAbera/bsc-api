    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perspective', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='operation.perspective')),
            ],
        ),
        migrations.CreateModel(
            name='KPI',
            fields=[
                ...
                ('objective', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='operation.objectives')),
                ('perspective', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='operation.perspective')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='operation_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
