    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perspective', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='InformationSystem.perspective')),
            ],
        ),
        migrations.CreateModel(
            name='KPI',
            fields=[
                ...
                ('objective', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='InformationSystem.objectives')),
                ('perspective', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='InformationSystem.perspective')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='information_system_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
