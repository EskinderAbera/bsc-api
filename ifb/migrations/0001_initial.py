    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perspective', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ifb.perspective')),
            ],
        ),
        migrations.CreateModel(
            name='KPI',
            fields=[
                ...
                ('objective', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ifb.objectives')),
                ('perspective', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ifb.perspective')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ifb_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
